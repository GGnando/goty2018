...
public class DialogueManager : MonoBehaviour {
    ...
    private Vector3 rotator; //use it so we can look at the camera
   ...
   // public Animator animator; //this is how we control the animations for the panel
    ...
    void Update()
    {
        //dialoguePanel.transform.LookAt(2 * dialoguePanel.transform.position - mcamera.transform.position);
        //dialoguePanel.transform.rotation = mcamera.transform.rotation;

        //make it so that the canvas is always looking at the player
        canvas.transform.LookAt(2 * canvas.transform.position - mcamera.transform.position);
        dialoguePanel.transform.position = knightHead.transform.position + adder;
    }
    ...
    public void StartDialogue(Dialogue dialogue)
    {
        ...
        dialoguePanel.transform.position = knightHead.transform.position + adder; //make dialogue panel appear above the knight
